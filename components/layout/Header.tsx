    ...
    <header className="flex flex-row items-center w-screen max-w-6xl justify-around py-4 absolute z-10 top-0 backdrop-filter backdrop-blur-lg bg-opacity-30">
      ...
      {session ? (
        <div className="flex flex-row items-center space-x-4">
          <div
            className="px-2 py-1 text-lg rounded-lg text-white bg-white bg-opacity-10 shadow-lg transition hover:shadow-xl cursor-pointer hover:bg-opacity-20 hover:scale-105"
